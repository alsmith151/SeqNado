...
rule macs2_with_input:
    ...
    benchmark: "seqnado_output/benchmark/macs/{sample}_{treatment}.benchmark" if config.get("benchmark", False) else None,
    shell:
        """
...
rule homer_with_input:
    ...
    benchmark: "seqnado_output/benchmark/homer/{sample}_{treatment}.benchmark" if config.get("benchmark", False) else None,
    params:
...
rule lanceotron_with_input:
    ...
    benchmark: "seqnado_output/benchmark/lanceotron/{sample}_{treatment}.benchmark" if config.get("benchmark", False) else None,
    params:
...
rule seacr:
    ...
    benchmark: "seqnado_output/benchmark/seacr/{sample}_{treatment}.benchmark" if config.get("benchmark", False) else None,
    params:

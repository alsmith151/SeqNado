...
rule macs2_with_input:
    ...
    benchmark: ".benchmarks/macs/{sample}_{treatment}.benchmark",
    shell:
        """
...
rule homer_with_input:
    ...
    benchmark: ".benchmarks/homer/{sample}_{treatment}.benchmark",
    params:
...
rule lanceotron_with_input:
    ...
    benchmark: ".benchmarks/lanceotron/{sample}_{treatment}.benchmark",
    params:
...
rule seacr:
    ...
    benchmark: ".benchmarks/seacr/{sample}_{treatment}.benchmark",
    params:

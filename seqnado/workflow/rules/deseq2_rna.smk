...
rule deseq2_params:
    ...
    container: None
    benchmark: "seqnado_output/benchmark/deseq2/deseq2_params.benchmark" if config.get("benchmark", False) else None
    run:
        import yaml
...
rule deseq2_report_rnaseq:
    ...
    benchmark: "seqnado_output/benchmark/deseq2/deseq2.benchmark" if config.get("benchmark", False) else None
    container:

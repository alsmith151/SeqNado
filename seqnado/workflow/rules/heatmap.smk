...
rule heatmap_matrix:
    ...
    benchmark: repeat("seqnado_output/benchmark/heatmap/matrix.txt", 3) if config.get("benchmark", False) else None,
    shell:
...
rule heatmap_plot:
    ...
    benchmark: repeat("seqnado_output/benchmark/heatmap/heatmap.txt", 3) if config.get("benchmark", False) else None,
    shell:
...
rule heatmap_metaplot:
    ...
    benchmark: repeat("seqnado_output/benchmark/heatmap/metaplot.txt", 3) if config.get("benchmark", False) else None,
    shell:

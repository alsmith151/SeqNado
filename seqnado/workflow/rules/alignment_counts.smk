...
rule salmon_counts_paired:
    ...
    benchmark: repeat("seqnado_output/benchmark/readcounts/salmon/salmon_{sample}.benchmark", 3) if config.get("benchmark", False) else None
    shell:
        """
...
rule get_salmon_counts:
    ...
    benchmark: repeat("seqnado_output/benchmark/readcounts/salmon/salmon_counts.benchmark", 3) if config.get("benchmark", False) else None
    script:

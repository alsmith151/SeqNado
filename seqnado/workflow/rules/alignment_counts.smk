...
rule salmon_counts_paired:
    ...
    benchmark: "seqnado_output/benchmark/readcounts/salmon/salmon_{sample}.benchmark" if config.get("benchmark", False) else None
    shell:
        """
...
rule get_salmon_counts:
    ...
    benchmark: "seqnado_output/benchmark/readcounts/salmon/salmon_counts.benchmark" if config.get("benchmark", False) else None
    script:

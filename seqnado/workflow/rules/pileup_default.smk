...
rule homer_make_tag_directory:
    ...
    benchmark: ".benchmarks/homer/maketagdirectory_{sample}.benchmark",
    shell:
...
rule homer_make_bigwigs:
    ...
    benchmark: ".benchmarks/homer/makebigwigs_{sample}.benchmark",
    resources:
        mem=lambda wildcards, attempt: define_memory_requested(initial_value=4, attempts=attempt, scale=SCALE_RESOURCES),
        runtime=lambda wildcards, attempt: define_time_requested(initial_value=2, attempts=attempt, scale=SCALE_RESOURCES),
    params:
...
rule deeptools_make_bigwigs:
    ...
    benchmark: ".benchmarks/pileups/deeptools/unscaled/{sample}.benchmark",
    shell:
        """
...
rule deeptools_make_bigwigs_rna_plus:
    ...
    benchmark: ".benchmarks/pileups/deeptools/unscaled/{sample}_plus.benchmark",
    shell:
        """
...
rule deeptools_make_bigwigs_rna_minus:
    ...
    benchmark: ".benchmarks/pileups/deeptools/unscaled/{sample}_minus.benchmark",
    shell:
        """
...
rule fragment_bedgraph:
    ...
    benchmark: ".benchmarks/bedgraphs/{sample}.benchmark",
    shell:"""

...
rule merged_saf:
    ...
    benchmark: "seqnado_output/benchmark/readcounts/featurecounts/{group}_saf.benchmark" if config.get("benchmark", False) else None,
    shell:"""
...
rule merged_counts:
    ...
    benchmark: "seqnado_output/benchmark/readcounts/featurecounts/{group}_counts.benchmark" if config.get("benchmark", False) else None,
    shell:"""

...
checkpoint methylation_split_bams:
    ...
    benchmark: ".benchmarks/methylation/split_bams/{sample}_{genome}.benchmark"
    shell: """
...
rule methyldackel_bias:
    ...
    benchmark: ".benchmarks/methylation/methyldackel/bias/{sample}_{genome}.benchmark"
    shell: """
...
rule calculate_conversion:
    ...
    benchmark: ".benchmarks/methylation/conversion.benchmark"
...
rule methyldackel_extract:
    ...
    benchmark: ".benchmarks/methylation/methyldackel/{sample}_{genome}.benchmark"
    shell: """
...
rule taps_inverted:
    ...
    benchmark: ".benchmarks/methylation/taps_inverted/{sample}_{genome}.benchmark"
    shell: """

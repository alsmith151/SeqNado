...
rule deeptools_make_bigwigs_scale:
    ...
    benchmark: OUTPUT_DIR + "/.benchmarks/pileups/deeptools/scaled/{sample}.tsv",
...
use rule deeptools_make_bigwigs_scale as deeptools_make_bigwigs_spikein with:
    ...
    benchmark: OUTPUT_DIR + "/.benchmarks/pileups/deeptools/spikein/{sample}.tsv",
...
rule deeptools_make_bigwigs_rna_spikein_plus:
    ...
    benchmark: OUTPUT_DIR + "/.benchmarks/pileups/deeptools/spikein/{sample}_plus.tsv",
...
rule deeptools_make_bigwigs_rna_spikein_minus:
    ...
    benchmark: OUTPUT_DIR + "/.benchmarks/pileups/deeptools/spikein/{sample}_minus.tsv",
